...
public class SmsFlashPromotionProductRelationController {
    ...
    @ResponseBody
    public R<CommonPage<SmsFlashPromotionProduct>> list(@RequestParam(value = "flashPromotionId") Long flashPromotionId,
        ...
        return R.success(CommonPage.restPage(flashPromotionProductList));
    }
}
