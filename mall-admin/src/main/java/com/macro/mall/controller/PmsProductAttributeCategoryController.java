...
public class PmsProductAttributeCategoryController {
    ...
    @ResponseBody
    public R<CommonPage<PmsProductAttributeCategory>> getList(@RequestParam(defaultValue = "5") Integer pageSize, @RequestParam(defaultValue = "1") Integer pageNum) {
        List<PmsProductAttributeCategory> productAttributeCategoryList = productAttributeCategoryService.getList(pageSize, pageNum);
        return R.success(CommonPage.restPage(productAttributeCategoryList));
    }
