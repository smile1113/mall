...
public class UmsMemberReceiveAddressController {
    ...
    @ResponseBody
    public R add(@RequestBody UmsMemberReceiveAddress address) {
    ...
    @ResponseBody
    public R update(@PathVariable Long id, @RequestBody UmsMemberReceiveAddress address) {
    ...
    @ResponseBody
    public R<List<UmsMemberReceiveAddress>> list() {
    ...
    @ResponseBody
    public R<UmsMemberReceiveAddress> getItem(@PathVariable Long id) {
